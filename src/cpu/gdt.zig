//CREDITS TO cat1000101 FOR GDT SYSTEM IT USED IN THIS FILE
//https://github.com/cat1000101/NyaOS/commit/12855fa760c6e0b25e84b917fcfe467cca20559b
...
pub fn initGdt() void {
    ...
    console.puts("initialize gdt\n");

    load_tss();
    console.puts("initialize Tss\n");
}
